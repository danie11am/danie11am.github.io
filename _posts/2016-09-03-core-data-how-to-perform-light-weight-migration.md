...
I recently needed to add an attribute to a Core Data model in one of my apps. Light weight migration is the right tool for this job. Here are some quick notes for future reference:
